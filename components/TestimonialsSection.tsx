    ...
    <section className="py-24 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-flex flex-col sm:flex-row items-center gap-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl sm:rounded-full px-4 sm:px-6 py-3 sm:py-2 shadow-sm mb-6 hover:shadow-md transition-all cursor-default">
            <div className="w-8 h-8 sm:w-6 sm:h-6 bg-white rounded-full flex items-center justify-center overflow-hidden shrink-0">
            ...
            <div className="flex flex-col text-center sm:text-left">
                <span className="text-[10px] sm:text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Google Rating</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            {/* Add Review Form */}
            <div className="bg-navy-900 dark:bg-slate-950 rounded-[2rem] p-6 md:p-8 text-white relative overflow-hidden order-1 lg:order-2">
                <div className="absolute top-0 right-0 w-48 md:w-64 h-48 md:h-64 bg-teal-500/20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
                
                <div className="relative z-10">
                    <h3 className="text-xl md:text-2xl font-bold mb-2">Share Your Experience</h3>
                    <p className="text-slate-300 text-xs md:text-sm mb-6">Your feedback helps us improve our agents.</p>
